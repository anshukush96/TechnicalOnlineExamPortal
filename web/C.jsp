<%-- 
    Document   : C
    Created on : Nov 12, 2024, 11:41:50 PM
    Author     : HOME
--%>

<%@page import="com.college.project.dao.CDao"%>
...
<!--        <style>
        ...
        background-image: url("https://png.pngtree.com/thumb_back/fh260/background/20190223/ourmid/pngtree-blue-technology-background-material-materialtechnology-backgroundarrowcolor-backgroundbackground-image_67560.jpg");
        background-size: cover;
    }
    </style>-->
<script>
...
<div class="login">
    ...
    <form id="quizform" action="C.jsp" method="post">
       
        <%
            if (ques !=null) {
        %>
          <div class="java">C Questions</div>
